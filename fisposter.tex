...
\begin{frame}
 \begin{columns}[t]
  ...
  \column{.45\linewidth}
   ...
   Over this time period, there was a consistent increase in the numbers of isolates reported for each organism (% ref to figure 1 here).
   Resistance to the empiric treatment ampicillin/amoxicillin increased for all three organisms between 2008 and 2013 (\textit{H. influenzae} 23.4\% to 26.3\%, IRR: 1.03, p\textless0.001, \textit{S. aureus} 75.0\% to 80.2\%, IRR: 1.01, p=0.141 and \textit{S. pneumoniae} 2.1\% to 3.9\%, IRR 1.12, p=0.001).
  ...
  The 17-valent vaccine against S. pneumoniae was introduced in 20xx and previous studies have noted a decline in resistance following the introduction of previous vaccines. % ref our work here. 
